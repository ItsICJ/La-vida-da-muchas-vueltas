...
public class Nombre {
    ...
    public static String nombreAleatorio(String genero) {
         ...
         * introduce por teclado, por eso la declaramos vacía.
         */
        String nombre = "";
        ...
        /**
         * Este if pedirá al usuaio tantas veces sea necesario que introduzca su
         * género hasta que sea igual a "mujer" o "hombre" usando recursividad.
         * Con .equalsIgnoreCase() conseguimos que obvie las mayúsculas y así
         * nos ahorramos el tener que especificar las 4 opciones posibles como
         * por ejemplo "femenino" y "Femenino".
         */
        if (!nombre.equalsIgnoreCase("mujer") && !nombre.equalsIgnoreCase("hombre")) {
            nombreAleatorio("Escriba su género por favor");
        } else {

            /**
             * Si el valor de la variable nombre de tipo String es igual a
             * "hombre" elegirá de forma aleatoria un nombre entre los case del
             * switch.
             */
             ...
             * Si el valor de la variable nombre de tipo String es igual a
             * "mujer" elegirá de forma aleatoria un nombre entre los case del
             * switch.
             */
